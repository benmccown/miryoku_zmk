...
&kp F1,            &kp F2,            &kp F3,            &kp F4,            &kp F5,            U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LCTRL,         &kp LGUI,         &kp LALT,           &kp LSHFT,         &kp F6,            &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &u_caps_word,      \
&kp F7,            &kp F8,            &kp F9,            &kp F10,           &kp F11,           &kp HOME,          &kp PG_DN,         &kp PG_UP,         &kp END,           &kp INS,           \
U_NP,              U_NP,              U_NA,              &kp F12,           U_NA,              U_NA,              U_NA,              U_NA,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE_INVERTEDT_FLIP \
U_WH_L,            U_WH_U,            U_MS_U,            U_WH_D,            U_NU,              &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &bt BT_CLR_ALL,        &bootloader,       \
...
U_NA,              &kp LG(W),         &kp RC(RS(TAB)),   &kp LC(TAB),       U_NA,              &kp PLUS,          &kp NUM_7,         &kp NUM_8,         &kp NUM_9,         &kp ASTRK,          \
&kp LCTRL,         &kp LGUI,          &kp LALT,          &kp LSHFT,         U_NA,              &kp MINUS,         &kp NUM_4,         &kp NUM_5,         &kp NUM_6,         &kp COMMA,          \
U_NA,              U_NA,              &kp LG(S),         U_NA,              U_NA,              &kp UNDERSCORE,    &kp NUM_1,         &kp NUM_2,         &kp NUM_3,         &kp BACKSLASH,         \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp DOT,           &kp NUM_0,         U_NA,              U_NP,              U_NP
...
&kp LCTRL,         &kp LGUI,         &kp LALT,           &kp LSHFT,         U_NU,              U_NU,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
